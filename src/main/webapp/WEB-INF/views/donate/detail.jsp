	...
	<div class="container-fluid mt-5">
		<div class="row justify-content-center">
			<div class="col-lg-10 shadow" style="background-color: white;">
						...
						<div class="carousel-inner">
							<c:forEach items="${donateDetail.photos }" var="photo" begin="0"
								...
								<div class="carousel-item active">
									<img class="d-block w-100 img-detail" height="400" src="${photo.path }">
								</div>
							</c:forEach>
				...
				<div class="row p-3" style="border-bottom: 1px dashed #0386A8;">
					<div class="col-lg-12 ">
						<h5>Nome:</h5>
						...
						<h5>Cor:</h5>
						<p class="ml-4">${donateDetail.color.name} <i class="fas fa-square ml-2"
							style="color: ${donateDetail.color.nameHexa}; line-height: 1.5rem;"></i></p>
				...
				<div class="row justify-content-center p-3">
					<div class="col-lg-12 my-3">
						<div>
							<h5>Solicitação</h5>
							<p>Nós da BabyShark® gostariamos que redigisse uma carta para
								o doador deste produto. Explicando o porquê do seu interesse,
								qual a sua situação e o porque está precisando desta doação.
								Tente ser o mais claro e sincero possível.</p>
						</div>
